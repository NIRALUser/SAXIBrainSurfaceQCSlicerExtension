...
class QC_ModelWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def onProcessStarted(self):
        ...
        self.ui.labelBar.setText("Number of processed subjects : "+str(self.progress)+"/"+str(self.nbSubjects))
    ...
    # check log file
        ...
        if self.logic.cliNode.GetStatus() & self.logic.cliNode.Completed :
            ...
            self.ui.labelBar.setText("Number of processed files : "+str(self.progress)+"/"+str(self.nbSubjects))
            ...
            if self.logic.cliNode.GetStatus() & self.logic.cliNode.ErrorsMask:
                ...
                msg.setText("Subjects predicted with success")
...
class QC_ModelLogic(ScriptedLoadableModuleLogic):
    ...
    https://github.com/Slicer/Slicer/blob/main/Base/Python/slicer/ScriptedLoadableModule.py
    """
    def __init__(self, input_dir = "None", out = "None", log_path = "None"):
        """
